...
public class ToolTip : MonoBehaviour
{
    ...
    string[] toolTips = { "Command Code:\r\nCollect the command codes hidden in each sector and insert them into the terminal in the central mainframe to activate the self destruct. ",
                           "Security Password:\r\nYour progress will be impeded by security checkpoints. Find the security passwords to gain access to the next sector. Pause the game with esc/p to view passwords",
